...
include{GET_SEQ_NAMES_BY_STR_CLASS} from './modules/getSeqNamesByStrClass.nf'
...
workflow {
    ...
    */
    ...
    strSeqNameFile=GET_SEQ_NAMES_BY_STR_CLASS(strClass, seqNameFile)
    ...
    mnnRsultsArray=COMPUTE_MNN_RESULTS(computeMnnResultsJoinedParameters, oneHotSeqFile, seqNameFile)
